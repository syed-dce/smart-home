...
/* Flush FIFOs */
#define NRF24L01_FLUSH_TX					do { NRF24L01_CSN_LOW; SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_FLUSH_TX_MASK); NRF24L01_CSN_HIGH; } while (0)
#define NRF24L01_FLUSH_RX					do { NRF24L01_CSN_LOW; SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_FLUSH_RX_MASK); NRF24L01_CSN_HIGH; } while (0)
...
uint8_t TM_NRF24L01_ReadRegister(uint8_t reg) {
	uint8_t value;
	NRF24L01_CSN_LOW;
	SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_READ_REGISTER_MASK(reg));
	value = SPI_I2S_ReceiveData(NRF24L01_SPI);
	NRF24L01_CSN_HIGH;
...
void TM_NRF24L01_WriteRegister(uint8_t reg, uint8_t value) {
	NRF24L01_CSN_LOW;
	SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_WRITE_REGISTER_MASK(reg));
...
void TM_NRF24L01_Transmit(uint8_t *data) {
	...
	SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_W_TX_PAYLOAD_MASK);
...
void TM_NRF24L01_GetData(uint8_t* data) {
	...
	SPI_I2S_SendData(NRF24L01_SPI, NRF24L01_R_RX_PAYLOAD_MASK);
	/* Read payload */
...
uint8_t TM_NRF24L01_GetStatus(void) {
	...
	status = SPI_I2S_ReceiveData(NRF24L01_SPI);
	/* Pull up chip select */
	NRF24L01_CSN_HIGH;
