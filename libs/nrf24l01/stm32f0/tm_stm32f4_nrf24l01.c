...
/* Flush FIFOs */
#define NRF24L01_FLUSH_TX					do { NRF24L01_CSN_LOW; SPI_SendData8(NRF24L01_SPI, NRF24L01_FLUSH_TX_MASK); NRF24L01_CSN_HIGH; } while (0)
#define NRF24L01_FLUSH_RX					do { NRF24L01_CSN_LOW; SPI_SendData8(NRF24L01_SPI, NRF24L01_FLUSH_RX_MASK); NRF24L01_CSN_HIGH; } while (0)
...
void TM_NRF24L01_WriteRegister(uint8_t reg, uint8_t value) {
	NRF24L01_CSN_LOW;
	SPI_SendData8(NRF24L01_SPI, NRF24L01_WRITE_REGISTER_MASK(reg));
	SPI_SendData8(NRF24L01_SPI, value);
	NRF24L01_CSN_HIGH;
}
...
void TM_NRF24L01_Transmit(uint8_t *data) {
	...
	SPI_SendData8(NRF24L01_SPI, NRF24L01_W_TX_PAYLOAD_MASK);
